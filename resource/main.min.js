var headerHeight=60;var senBodyData;var currentPageNum=1;var mountedApp=!1;function loadBasicData(){reqwest({url:'/data/basic.json?v=b28b52c30b7e348a7eea55852816450c',type:'json',method:'get',success:function(resp){senBasicData=resp;var extraData={isShrinkedHeader:!1,isLoading:!0,isMobileMenu:!1,firstRun:!1,CurrentPage:"index",coverImg:{},hasCoverImg:!1,toc:"",activeToc:-1,tocItems:[],};senBasicData.status=extraData;if(currentMode!='post'){loadContentData()}else{embedContentData()}},error:function(){alert("Data error...")}})}
...
this.status.activeToc=thisScrolled}},isActiveToc:function(cToc){if(cToc==this.status.activeToc){console.log(cToc);return!0}else{return!1}}}})}
loadBasicData()