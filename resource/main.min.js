...
var dataSrc='page-'+currentPageNum+'.json?v=afd9a41905765fab1cb9bb637b645882';break;case 'tags':var dataSrc='tags.json?v=afd9a41905765fab1cb9bb637b645882';senBasicData.status.CurrentPage='tags';break;case 'archive':var dataSrc='archive.json?v=afd9a41905765fab1cb9bb637b645882';senBasicData.status.CurrentPage='archive';break;default:var dataSrc='page-1.json?v=afd9a41905765fab1cb9bb637b645882'}
return dataSrc}
function turnPage(pn){if(currentMode=='main'){senBasicData.status.isLoading=!0;reqwest({url:'/data/page-'+pn+'.json?v=afd9a41905765fab1cb9bb637b645882',type:'json',method:'get',success:function(resp){senBasicData.bodydata=resp;location.hash="#page/"+pn;senBasicData.status.isLoading=!1;document.body.scrollIntoView({behavior:'smooth'})}})}}
