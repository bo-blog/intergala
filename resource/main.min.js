var headerHeight=60;var senBodyData;var currentPageNum=1;var mountedApp=!1;function loadBasicData(){reqwest({url:'/data/basic.json?v=6b024a54af6d6c4090cefff2a69f8d9c',type:'json',method:'get',success:function(resp){senBasicData=resp;var extraData={isShrinkedHeader:!1,isLoading:!0,isMobileMenu:!1,firstRun:!1,CurrentPage:"index",coverImg:{},hasCoverImg:!1,toc:"",activeToc:-1,tocItems:[],};senBasicData.status=extraData;if(currentMode!='post'){loadContentData()}else{embedContentData()}},error:function(){alert("Data error...")}})}
...
var dataSrc='page-'+currentPageNum+'.json?v=6b024a54af6d6c4090cefff2a69f8d9c';break;case 'tags':var dataSrc='tags.json?v=6b024a54af6d6c4090cefff2a69f8d9c';senBasicData.status.CurrentPage='tags';break;case 'archive':var dataSrc='archive.json?v=6b024a54af6d6c4090cefff2a69f8d9c';senBasicData.status.CurrentPage='archive';break;default:var dataSrc='page-1.json?v=6b024a54af6d6c4090cefff2a69f8d9c'}
return dataSrc}
function turnPage(pn){if(currentMode=='main'){senBasicData.status.isLoading=!0;reqwest({url:'/data/page-'+pn+'.json?v=6b024a54af6d6c4090cefff2a69f8d9c',type:'json',method:'get',success:function(resp){senBasicData.bodydata=resp;location.hash="#page/"+pn;senBasicData.status.isLoading=!1;document.body.scrollIntoView({behavior:'smooth'})}})}}
