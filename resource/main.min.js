var headerHeight=60;var senBodyData;var currentPageNum=1;var mountedApp=!1;function loadBasicData(){reqwest({url:'/data/basic.json?v=6eceb9eaa8626c60c68af149c52a6d18',type:'json',method:'get',success:function(resp){senBasicData=resp;var extraData={isShrinkedHeader:!1,isLoading:!0,isMobileMenu:!1,firstRun:!1,CurrentPage:"index",coverImg:{},hasCoverImg:!1,toc:"",activeToc:-1,tocItems:[],};senBasicData.status=extraData;if(currentMode!='post'){loadContentData()}else{embedContentData()}},error:function(){alert("Data error...")}})}
